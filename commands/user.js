exports.run = (client, message, args, level) => { // eslint-disable-line no-unused-vars
  ...
  // This nicely styles the nickname label so it does not just vomit 'null' but instead says "None".
  // Might move it to just an if statement but it is nicer like this withouth having 2000000 addField() commands
  ...
  userInfoEmbed.addFields(
    { name: ":name_badge: **Nickname:** ", value: hasNickname(taggedUser.nickname), inline: true },
    { name: "\u200B", value: "\u200B", inline: true },
    { name: ":id: **Id:** ", value: "`"+taggedUser.id+"`",  inline: true },
    //
    { name: ":globe_with_meridians: **Account Created:**", value: `__${userCreatedDate}__`, inline: true },
    { name: "\u200B", value: "\u200B", inline: true },
    { name: ":inbox_tray: **User Joined Guild:**", value: `__${userGuildJoinDate}__`, inline: true },
  );
  ...
  userInfoEmbed.setFooter("Requested by: " + message.author.username, message.author.displayAvatarURL());
