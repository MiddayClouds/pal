exports.run = (client, message, args, level) => {
  ...
  const userCreatedDate = client.getDate(
    new Date(taggedUser.user.createdTimestamp)
  );
  const userGuildJoinDate = client.getDate(
    new Date(taggedUser.joinedTimestamp)
  );
