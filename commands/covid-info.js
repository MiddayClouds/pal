  ...
  if (!args[0]) {
    api.all().then(recievedData => {
      ...
      countryInfo.addFields(
          ...
          },
          {
            name : "Cases Today:",
            value :
                new Intl.NumberFormat("en-us").format(recievedData.todayCases),
            inline : true
          },
          {name : "\u200B", value : "\u200B"},
          {
          ...
          },
          {
            name : "Deaths Today:",
            value :
                new Intl.NumberFormat("en-us").format(recievedData.todayDeaths),
            inline : true
          },
          {name : "\u200B", value : "\u200B"},
          {
            ...
            value :
                new Intl.NumberFormat("en-us").format(recievedData.recovered),
            inline : true
          },
    ...
    api.countries({country : country}).then(recievedData => {
      ...
      if (recievedData.country == null) {
        ...
        // countryInfo.setURL('https://discord.js.org/')
        countryInfo.setDescription(`:busts_in_silhouette: Country Population: ${
            new Intl.NumberFormat("en-us").format(
                recievedData.population)}\n:map: Country Continent: ${
        ...
        countryInfo.addFields(
            ...
            {name : "\u200B", value : "\u200B"},
            {
              name : "Total Deaths:",
              value :
                  new Intl.NumberFormat("en-us").format(recievedData.deaths),
              inline : true
            },
            {
              name : "Deaths Today:",
            ...
            {name : "\u200B", value : "\u200B", inline : false},
            {
              name : "Active Cases:",
              value :
                  new Intl.NumberFormat("en-us").format(recievedData.active),
              inline : true
            },
            {
              name : "Critical Active Cases:",
              value :
                  new Intl.NumberFormat("en-us").format(recievedData.critical),
              inline : true
            },
            {name : "\u200B", value : "\u200B"},
        );
