exports.run = async (client, message, args,
  ...
  // const personURL =
  // `https://www.thispersondoesnotexist.com/image.jpg?${gen}`;
  ...
  const errors = [
    ...
    "416", "417", "418", "420", "421", "421", "422", "423", "424", "425",
    "426", "429", "431", "444", "450", "451", "499", "500", "501", "502",
  ...
  const download = (url, path, callback) => {
    request.head(
        url, (err, res, body) => { // eslint-disable-line no-unused-vars
  ...
  if (args[0] === "person") {
    download(personURL, personPATH, () => {
      ...
      ganEmbed.setFooter(
          "Imagined by a GAN | Powered by: thispersondoesnotexist.com",
          "https://feen.us/xvzn8g.png");
    ...
    download(artURL, artPATH, () => {
      ...
      ganEmbed.setFooter(
          "Imagined by a GAN | Powered by: thisartworkdoesnotexist.com",
          "https://feen.us/xvzn8g.png");
    ...
    got("http://inspirobot.me/api?generate=true").then((res) => {
      ...
      ganEmbed.setFooter("Powered by: inspirobot.me",
                         "https://inspirobot.me/website/images/favicon.png");
      ganEmbed.setImage(res.body);
      message.channel.send(ganEmbed);
    });
  } else {
    message.channel.send(
        "Please choose an input from the avaible list:\n- `person`\n- `art`\n- `error`\n- `quote`\nExample: `" +
        message.settings.prefix + "generate art`");
  }
};
