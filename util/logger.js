...
const webhookLogger = new Discord.WebhookClient(config.webhookLogger[0], config.webhookLogger[1]);
...
exports.log = (content, type = "log") => {
  ...
  switch (type) {
    case "log": {
      ...
      return webhookLogger.send("```asciidoc\nTIMESTAMP::" + timestamp + "\nLOG:: " + content + "\n```");
    }
    case "warn": {
    ...
    case "error": {
      ...
      return webhookLogger.send(":sos: ```asciidoc\nTIMESTAMP::" + timestamp + " \nERROR:: " + content + "\n```");
    }
    case "debug": {
